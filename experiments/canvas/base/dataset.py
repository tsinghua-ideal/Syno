...
def get_loaders(args, proxy: bool = False):
    # Whether proxy.
    root = args.kas_proxy_root if proxy else args.root
    if root == '':
        return None, None
    ...
    dataset_train = create_dataset(
        name='', root=root, split=args.train_split, batch_size=args.batch_size)
    dataset_eval = create_dataset(
        name='', root=root, split=args.val_split, batch_size=args.batch_size)
