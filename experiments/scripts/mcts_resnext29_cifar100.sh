...
--kas-server-addr 0.0.0.0 --kas-server-port 7070 --kas-server-save-dir results/cifar100-resnext29-session-v20231122 --kas-server-save-interval 3600\
 ...
 --kas-max-flops-ratio 0.95 --kas-min-flops-ratio 0.5 \
