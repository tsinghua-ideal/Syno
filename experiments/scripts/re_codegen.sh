...
python analysis/re_codegen.py --model torchvision/resnet18 --kas-sampler-workers 400 \
...
python analysis/re_codegen.py --model torchvision/resnext29_2x64d --kas-sampler-workers 400 \
...
python analysis/re_codegen.py --model torchvision/densenet121 --kas-sampler-workers 400 \
...
python analysis/re_codegen.py --model torchvision/efficientnet_v2_s --kas-sampler-workers 400 \
