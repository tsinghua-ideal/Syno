...
class Handler(BaseHTTPRequestHandler):
    ...
    def explore(self):
        ...
        response = explorer.serve(payload, f"{parse_results.scheme}://{parse_results.netloc}")
        ...
        try:
            ...
            logging.debug(
                f"Encountered BrokenPipeError while processing {payload}"
            )
    ...
    def explorer_files(self, file_name: str):
        ...
        file_path = os.path.join(self.session.search_space_explorer.working_dir, file_name)
